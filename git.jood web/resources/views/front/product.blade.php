    ...
    <section class="product_section layout_padding">
      <div class="container">
        ...
        <div class="product_container">
          <div class="box">
            <div class="img-box">
              <img src="images/liber.jpg" alt="" />

            </div>
            <div class="detail-box">
              <h5>Liber - Yves Saint Laurant</h5>
              <h4>Eau De Parfum</h4>
          ...
          <div class="box">
            ...
            <div class="detail-box">
              <h5>Coco Mademioselle - Chanel</h5>
              <h4>Eau de parfum</h4>
              <h4><span>RY</span>10000</h4>
              {{-- <a href="{{ route('cart') }}">View cart</a> --}}
              <a href="{{ route('cart') }}"> Buy Now </a>
          ...
          <div class="box">
            <div class="img-box">
              <img src="images/delina2.png" alt="" />
            </div>
            <div class="detail-box">
              <h5>Delina - De Marly</h5>
              <h4>Eau de parfum</h4>
              <h4><span>RY</span>13500</h4>
              {{-- <a href="{{ route('cart') }}">View cart</a> --}}
              <a href="{{ route('cart') }}"> Buy Now </a>
            </div>
          </div>
